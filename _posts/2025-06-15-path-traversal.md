...
![](/assets/img/posts/path_traversal/image.png)

# PATH là gì?

Path là đường dẫn trong thực tế là đường đi từ nơi này đến nơi khác.

![](/assets/img/posts/path_traversal/image1.png)
...
![](/assets/img/posts/path_traversal/image4.png)
...
![](/assets/img/posts/path_traversal/image5.png)
...
- 2 dấu chấm (`..`): Tượng trung cho đường dẫn đến thư mục cha (parent directory).
    ...
    ![](/assets/img/posts/path_traversal/image6.png)
...
![](/assets/img/posts/path_traversal/image10.png)
...
![](/assets/img/posts/path_traversal/image11.png)

Sử dụng BurpSuit hoặc view source để đọc flag:

![](/assets/img/posts/path_traversal/image12.png)

Quá trình untrusted data rơi vào nguy hiểm:

![](/assets/img/posts/path_traversal/image13.png)
...
![](/assets/img/posts/path_traversal/image14.png)
...
![](/assets/img/posts/path_traversal/image15.png)
...
![](/assets/img/posts/path_traversal/image16.png)
...
![](/assets/img/posts/path_traversal/image17.png)
...
- Upload thành công nhưng file test.php không được thực thi mà hiển thị dưới dạng text.
    ...
    ![](/assets/img/posts/path_traversal/image18.png)
...
![](/assets/img/posts/path_traversal/image19.png)
...
- Đoạn code tạo dir từ dòng 5 đến dòng 11:
    ...
    ![](/assets/img/posts/path_traversal/image20.png)
...
- Đoạn code tạo album từ dòng 17 đến dòng 19:
    ...
    ![](/assets/img/posts/path_traversal/image21.png)
...
- Đoạn code save file từ dòng 26 đến dòng 31:
    ...
    ![](/assets/img/posts/path_traversal/image22.png)
...
![](/assets/img/posts/path_traversal/image24.png)

## Phân tích con bọ Path Traversal:

Các biến thể khác của lỗi bảo mật Path Traversal

![](/assets/img/posts/path_traversal/image25.png)
...
![](/assets/img/posts/path_traversal/image26.png)
